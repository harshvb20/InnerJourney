        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="counsellor.php">For Counsellor/Mentor</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="register.php">Register Now</a>
                    </li>
                </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="contactForm" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" name="userlogin" class="form-control-submit-button">Login</button>
                        </div>

                    </form>
                    <p>New User? Click below for Registeration</p>
                    <a class="btn-solid-reg mb-5" href="register.php">Register Now</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of form-1 -->
