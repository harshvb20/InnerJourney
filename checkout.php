...
// $webtitle='innerJourney';
// $displayCurrency='INR';
// $imageurl='images/favicon1.jpg';
// $orderData = [
//     'receipt'         => 3456,
//     'amount'          => $fee*100, // 2000 rupees in paise
//     'currency'        => 'INR',
...
//     "notes"             => [
//     "address"           => "",
//     "merchant_order_id" => $counsellor_email,
//     ],
//     "theme"             => [
//     "color"             => "#F37254"
//     ],
...
require_once "config.php";
$counsellor_email=$_POST['button'];
$_SESSION['counsellor_email']=$_POST['button'];
$select_query="SELECT * from `counsellor_profile` WHERE email='$counsellor_email'";
$result_query=mysqli_query($conn,$select_query);
$row = mysqli_fetch_assoc($result_query);
