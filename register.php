...
if (isset($_POST['submitregister'])) {
    ...
    if ($emailcount > 0 || $phonecount > 0) {
        ...
        if ($password === $cpassword) {
            $sql = "INSERT INTO `students`.`user` ( `name`, `email`, `phone`, `password`, `dt`) VALUES ( '$name', '$email', '$phone', '$pass', current_timestamp());";
            //echo $sql;
        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="counsellor.php">For Counseller/Mentor</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    if ($insert) {
                        echo "<p style='color:green'> Thankyou for the Registration. We will contact you. </p>";
                    }
                    ?>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn-solid-reg mb-5" href="login.php">Login</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of form-1 -->
